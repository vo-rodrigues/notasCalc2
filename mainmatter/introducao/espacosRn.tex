...
\begin{figure}[ht]
    ...
    \draw[->,ultra thick] (0,0,-4)--(0,0,4) node[above]{$z$};
    % Centro da bola
    % Centro da bola (ponto)
    \filldraw[black] (3,4,3) circle (2pt);
    \node[below right] at (3,4,3) {$p$};
    % Raio da bola
    \draw[dashed] (3,4,3) circle (1.5);
    % Desenho do raio da bola
    \draw[-,thick] (3,4,3) -- (4.5,4,3) node[above right]{$r$};
    \end{tikzpicture}
    \caption{Bola aberta de centro $p$ e raio $r$ em $\mathbb R^3$.}
\end{figure}
