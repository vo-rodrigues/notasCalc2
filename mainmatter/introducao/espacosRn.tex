...
\begin{definition}
    Seja $A\subseteq \mathbb R^n$ um conjunto e $p \in A$ um ponto. Dizemos que $p$ é um \emph{ponto isolado} \index{ponto isolado} de $A$ se existe um $\delta>0$ tal que $B(p,\delta) \cap A = \{p\}$.
